...
// O molde a ser utilizado é definido pelo seu gosto;
...
//     this.identidade=()=>{
//         `Olá meu nome é ${this.nome} ${this.sobrenome} e tenho ${this.idade}`;
//     };
// };

Pessoa.prototype.identidade =()=>{
    return `Olá meu nome é ${this.nome} ${this.sobrenome} e tenho ${this.idade}`;
}

// Instância
const pessoa1 = new Pessoa('Marcos Eduardo', 'Fernandes', 18); // <-Pessoa = Função Construtora;
const pessoa2 = new Pessoa('Gabriel', 'Monteiro', 25); // <-Pessoa = Função Construtora;
